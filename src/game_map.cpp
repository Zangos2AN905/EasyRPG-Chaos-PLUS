...
bool Game_Map::LoopHorizontal() {
	return map != nullptr && (map->scroll_type == lcf::rpg::Map::ScrollType_horizontal || map->scroll_type == lcf::rpg::Map::ScrollType_both);
}

bool Game_Map::LoopVertical() {
	return map != nullptr && (map->scroll_type == lcf::rpg::Map::ScrollType_vertical || map->scroll_type == lcf::rpg::Map::ScrollType_both);
}
...
int Game_Map::GetTilesX() {
	return map != nullptr ? map->width : 0;
}

int Game_Map::GetTilesY() {
	return map != nullptr ? map->height : 0;
}
