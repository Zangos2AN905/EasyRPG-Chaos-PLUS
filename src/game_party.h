...
public:
	...
	/**
	 * Gets actors visible to this player in team/chaotix mode.
	 * Returns only the player's assigned actor, or full party in other modes.
	 */
	std::vector<Game_Actor*> GetTeamActors() const;
