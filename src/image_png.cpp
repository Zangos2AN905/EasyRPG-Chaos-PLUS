...
bool ImagePNG::Write(std::ostream& os, uint32_t width, uint32_t height, uint32_t* data, bool with_alpha) {
	...
	png_set_IHDR(write, info, width, height, 8,
				 with_alpha ? PNG_COLOR_TYPE_RGBA : PNG_COLOR_TYPE_RGB, PNG_INTERLACE_NONE,
