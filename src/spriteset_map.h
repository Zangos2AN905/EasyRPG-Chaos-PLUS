...
public:
	...
	/** Add a character sprite at runtime (used by multiplayer) */
	void AddCharacterSprite(Game_Character* character);
	/** Remove all runtime sprites that reference a character. */
	void RemoveCharacterSprites(Game_Character* character);
